...
export const REMOTE_SIGNALER_HOST = 'node-server-executor.herokuapp.com';
export const REMOTE_SIGNALER_PORT = 80;
...
export class PadDisconnect {
  static messageType = 'PadDisconnect';
