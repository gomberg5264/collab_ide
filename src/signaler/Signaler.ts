...
class Signaler {
    ...
    start(port: number, host: string) {
        ...
        this.io.of('/bp').on('connection', socket => {
            ...
            socket.on(PadDisconnect.messageType, (data: PadDisconnect) => {
                this.log(socket, PadDisconnect.messageType, data);
                this.broadcastToPad(socket, data.padId, PadDisconnect.messageType, data);
            });
